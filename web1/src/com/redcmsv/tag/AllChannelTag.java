		...
		if(channelList != null && channelList.size() > 0) {
			for(Channel c : channelList) {
				...
				if(model != null) {
					...
					sb.append("<td><a href='#' class='btn btn-danger'>修改</a></td>");
					sb.append("<td><a href='#' class='btn btn-warning'>删除</a></td>");
					sb.append("<td><a href='#' class='btn btn-success'>发布</a></td>");
					sb.append("</tr>");
					List<Channel> childChannelList = ChannelService.selectChannelByParentId(c.getParent_id());
