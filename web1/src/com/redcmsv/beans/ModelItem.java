...
public class ModelItem {
	...
	private String field_dis;//字段描述
	private int priority;//排序
	private String def_value;//默认值
	private String opt_value;//可选值
	private String txt_size;//长度
	private String help_info;//帮助信息
	private byte data_type;//数据类型
	private byte is_single;//单独行
	private byte is_channel;//是是否是栏目表
	private byte is_custom;//自定义字段
	private byte is_display;//显示
	private byte is_required;//必须
	
	public ModelItem() {
		
	}

	public ModelItem(long id, long model_id, String field, String field_dis, int priority, String def_value,
			String opt_value, String txt_size, String help_info, byte data_type, byte is_single, byte is_channel,
			byte is_custom, byte is_display, byte is_required) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ModelItem [id=" + id + ", model_id=" + model_id + ", field=" + field + ", field_dis=" + field_dis
				+ ", priority=" + priority + ", def_value=" + def_value + ", opt_value=" + opt_value + ", txt_size="
				+ txt_size + ", help_info=" + help_info + ", data_type=" + data_type + ", is_single=" + is_single
				+ ", is_channel=" + is_channel + ", is_custom=" + is_custom + ", is_display=" + is_display
