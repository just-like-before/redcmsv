...
public class DataField {
	...
	private byte is_single;
	private byte is_channel;
	private byte is_custom;
	private byte is_display;
	...
	public DataField(long id, String field, String field_dis, int priority, String def_value, String opt_value,
	...
	public String toString() {
		return "DataField [id=" + id + ", field=" + field + ", field_dis=" + field_dis + ", priority=" + priority
