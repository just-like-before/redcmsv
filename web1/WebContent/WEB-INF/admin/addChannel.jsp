					      		...
					      		<c:choose>
					      			...
					      			<c:when test="${modelItem.data_type==1 }"><!--4类型一 -->
					      				<c:choose>
					      					...
					      					<c:otherwise>
					      						<input type="text" name="${modleItem.field }" class="form-control" placeholder="请输入${modelItem.field_dis }">
					      					</c:otherwise>
					      				</c:choose>
					      			</c:when>
					      			...
					      			<c:when test="${modelItem.data_type==2 }"><!-- 7数字 -->
					      				...
					      				<c:if test="${!modelItem.field.equals('priority') }">
					      					<input type="number" name="${modleItem.field }" class="form-control" placeholder="请输入${modelItem.field_dis }">
					      				</c:if>
					      			</c:when>
					      			...
					      			<c:when test="${modelItem.data_type==4 }"><!-- 9日期 -->
					      				<input type="date" class="form-control" name="${modleItem.field }"/>
					      			</c:when>
